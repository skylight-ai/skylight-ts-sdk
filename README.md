...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage _skylight_ API.
...
const sdk = new Skylight({ debugLogger: console });
```
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=skylight-sdk&utm_campaign=typescript)
