...
> {
  const input: operations.RunRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.RunRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ClaudeRequest, { explode: true });
  ...
  const path = pathToFunc("/agent/run/{instance_id}")(pathParams);
