...
export function windowsStart(
  ...
  Result<
    components.InstanceStartResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.InstanceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/windows/start")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.InstanceStartResponse$inboundSchema),
