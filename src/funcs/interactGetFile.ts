...
export function interactGetFile(
  ...
  Result<
    operations.GetFileResponse200GetFile,
...
> {
  ...
  const path = pathToFunc("/interact/file/{instance_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetFileResponse200GetFile$inboundSchema),
