...
> {
  const input: operations.PauseRequest = {
    instanceId: instanceId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.PauseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/windows/pause/{instance_id}")(pathParams);
