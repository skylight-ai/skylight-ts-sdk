...
| `files`                                                                                      | [components.AgentStatusResponseFiles](../../models/components/agentstatusresponsefiles.md)[] | :heavy_check_mark:                                                                           | List of files downloaded by the agent                                                        |                                                                                              |
...
| `humanInputRequest`                                                                          | [components.HumanInputRequest](../../models/components/humaninputrequest.md)                 | :heavy_minus_sign:                                                                           | Information about the human input being requested, if agent is waiting                       |                                                                                              |